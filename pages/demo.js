            ...
            hotSpots: [
              {
                ...
                yaw: 90,
                type: "info",
                text: "Explore this beautiful park - A perfect example of Pakistan's urban green spaces",
              },
              {
                pitch: -5,
                yaw: -45,
                type: "info",
                text: "Local Heritage - Discover the stories behind this scenic location",
              },
            ],
          });
          setLoading(false);
      ...
      <div>
        ...
        >
          ...
          >
            ...
            >
              Experience our immersive 360° virtual tours. Click and drag to
              explore!
            </Typography>
          </div>
        </Box>
        ...
        >
          ...
          >
            ...
            <Typography sx={{ mb: 4, fontSize: "1.1rem" }}>
              We can create immersive virtual tours for your heritage site or
              business.
            </Typography>
            <Button
              variant="contained"
